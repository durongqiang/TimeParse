...
testCases.append((u'大年二十九', temp, 'day', None))
#23
time_now = datetime.now()
...
temp = '{0}年{1}月{2}日'.format(result_time.solarYear, result_time.solarMonth, result_time.solarDay)
testCases.append((u'正月15', temp, 'day', None))
#26
time_now = datetime.now()
...
temp = '{0}年{1}月{2}日'.format(result_time.solarYear, result_time.solarMonth, result_time.solarDay)
testCases.append((u'农历八月十五', temp, 'day', None))
#28
...
testCases.append((u'国庆', temp, 'day', None))
#41
time_now = datetime.now()
L_time = Lunar(time_now.year, 8, 15)
tf_class = LunarSolarConverter()
...
if cond.days < 0:
    result_time = tf_class.LunarToSolar(Lunar(time_now.year + 1, 8, 15))
temp = '{0}年{1}月{2}日'.format(result_time.solarYear, result_time.solarMonth, result_time.solarDay)
testCases.append((u'中秋', temp, 'day', None))
#42
time_now = datetime.now()
...
testCases.append((u'圣诞', temp, 'day', None))
#43
time_now = datetime.now()
